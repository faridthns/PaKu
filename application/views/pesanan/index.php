            ...
            foreach ($pesanan_baru as $pb) : ?>
              <tr>
                ...
                <td>
                  ...
                  <button type="button" class="btn btn-sm btn-outline-warning mb-2 button-resi" data-id="<?= $pb['id_pesanan']; ?>" data-toggle="modal" data-target="#tb-resi" title="Tambah Nomor Telpon">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">tambah no Telpon Kuli</h5>
        ...
        <div class="container">
          ...
          <form method="POST" class="form-resi">
            ...
            <div class="form-group">
              <label for="resi">Nomer Telpon</label>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary edit-resi" data-dismiss="modal">Kirim No.Telp</button>
        </form>
      </div>
    </div>
  </div>
